...
class SpellCheckClientOperationsMixin(object):
    ...
    def spell_checker(
        ...
        action_type=None,  # type: Optional[Union[str, "_models.ActionType"]]
        app_name=None,  # type: Optional[str]
        country_code=None,  # type: Optional[str]
        client_machine_name=None,  # type: Optional[str]
        ...
        mode=None,  # type: Optional[Union[str, "_models.Mode"]]
        pre_context_text=None,  # type: Optional[str]
        post_context_text=None,  # type: Optional[str]
        **kwargs  # type: Any
    ):
        # type: (...) -> "_models.SpellCheck"
        ...
        if pre_context_text is not None:
            query_parameters["PreContextText"] = self._serialize.query(
                "pre_context_text", pre_context_text, "str"
            )
        if post_context_text is not None:
            query_parameters["PostContextText"] = self._serialize.query(
                "post_context_text", post_context_text, "str"
            )
