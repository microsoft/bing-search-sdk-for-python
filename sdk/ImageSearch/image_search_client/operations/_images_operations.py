...
class ImagesOperations(object):
    ...
    :type models: ~image_search_client.models
    ...
    def search(
        ...
        aspect=None,  # type: Optional[Union[str, "_models.ImageAspect"]]
        color=None,  # type: Optional[Union[str, "_models.ImageColor"]]
        ...
        image_content=None,  # type: Optional[Union[str, "_models.ImageContent"]]
        image_type=None,  # type: Optional[Union[str, "_models.ImageType"]]
        license=None,  # type: Optional[Union[str, "_models.ImageLicense"]]
        market=None,  # type: Optional[str]
        max_file_size=None,  # type: Optional[int]
        max_height=None,  # type: Optional[int]
        max_width=None,  # type: Optional[int]
        min_file_size=None,  # type: Optional[int]
        min_height=None,  # type: Optional[int]
        min_width=None,  # type: Optional[int]
        offset=None,  # type: Optional[int]
        safe_search=None,  # type: Optional[Union[str, "_models.SafeSearch"]]
        size=None,  # type: Optional[Union[str, "_models.ImageSize"]]
        ...
        **kwargs  # type: Any
        ...
        The Image Search API lets you send a search query to Bing and get back a list of relevant
        images. This section provides technical details about the query parameters and headers that you
        use to request images and the JSON response objects that contain them. For examples that show
        how to make requests, see `Searching the Web for Images <https://docs.microsoft.com/en-
        us/bing/bing-image-search/overview>`_.

        :param x_bing_apis_sdk: Activate swagger compliance.
        :type x_bing_apis_sdk: str or ~image_search_client.models.XBingApisSDK
        :param query: The user's search query term. The term cannot be empty. The term may contain
         ...
         insights query (see `insightsToken <https://docs.microsoft.com/en-us/bing/bing-image-
        ...
        :param accept_language: A comma-delimited list of one or more languages to use for user
         ...
         <https://docs.microsoft.com/en-us/bing/bing-image-search/overview>`_ query parameter are
         mutually exclusive; do not specify both. If you set this header, you must also specify the `cc
         <https://docs.microsoft.com/en-us/bing/bing-image-search/overview>`_ query parameter. To
         ...
         multiple languages. Otherwise, use the `mkt <https://docs.microsoft.com/en-us/bing/bing-image-
         search/overview>`_ and `setLang <https://docs.microsoft.com/en-us/bing/bing-image-
        ...
        :type aspect: str or ~image_search_client.models.ImageAspect
        ...
        :type color: str or ~image_search_client.models.ImageColor
        :param country_code: A 2-character country code of the country where the results come from. For
         a list of possible values, see `Market Codes <https://docs.microsoft.com/en-us/bing/bing-image-
         search/overview>`_. If you set this parameter, you must also specify the `Accept-Language
         <https://docs.microsoft.com/en-us/bing/bing-image-search/overview>`_ header. Bing uses the
         first supported language it finds from the languages list, and combine that language with the
         ...
         parameters. This parameter and the `mkt <https://docs.microsoft.com/en-us/bing/bing-image-
         search/overview>`_ query parameter are mutually exclusive—do not specify both.
        ...
        :type freshness: str or ~image_search_client.models.Freshness
        ...
        :param id: An ID that uniquely identifies an image. Use this parameter to ensure that the
         ...
         <https://docs.microsoft.com/en-us/bing/bing-image-search/overview>`_ object's imageId field
        ...
        :param image_content: Filter images by the following content types. Face: Return images that
         ...
         shoulders.
        :type image_content: str or ~image_search_client.models.ImageContent
        :param image_type: Filter images by the following image types. AnimatedGif: Return only
         ...
         background.
        :type image_type: str or ~image_search_client.models.ImageType
        ...
        :type license: str or ~image_search_client.models.ImageLicense
        :param market: The market where the results come from. Typically, mkt is the country where the
         ...
         <https://docs.microsoft.com/en-us/bing/bing-image-search/overview>`_. NOTE: If known, you are
         ...
         `Market Codes <https://docs.microsoft.com/en-us/bing/bing-image-search/overview>`_\ , Bing uses
         a best fit market code based on an internal mapping that is subject to change. This parameter
         and the `cc <https://docs.microsoft.com/en-us/bing/bing-image-search/overview>`_ query
        ...
        :param offset: The zero-based offset that indicates the number of images to skip before
         ...
         <https://docs.microsoft.com/en-us/bing/bing-image-search/overview>`_ - count). Use this
         ...
         <https://docs.microsoft.com/en-us/bing/bing-image-search/overview>`_. Use this parameter only
        ...
        :type safe_search: str or ~image_search_client.models.SafeSearch
        ...
        :type size: str or ~image_search_client.models.ImageSize
        :param set_lang: The language to use for user interface strings. Specify the language using the
         ...
         <https://docs.microsoft.com/en-us/bing/bing-image-search/overview>`_ header are mutually
    ...
    def details(
        ...
        client_ip=None,  # type: Optional[str]
        location=None,  # type: Optional[str]
        crop_bottom=None,  # type: Optional[float]
        crop_left=None,  # type: Optional[float]
        crop_right=None,  # type: Optional[float]
        crop_top=None,  # type: Optional[float]
        crop_type=None,  # type: Optional[Union[str, "_models.ImageCropType"]]
        country_code=None,  # type: Optional[str]
        id=None,  # type: Optional[str]
        image_url=None,  # type: Optional[str]
        insights_token=None,  # type: Optional[str]
        modules=None,  # type: Optional[List[Union[str, "_models.ImageInsightModule"]]]
        market=None,  # type: Optional[str]
        safe_search=None,  # type: Optional[Union[str, "_models.SafeSearch"]]
        set_lang=None,  # type: Optional[str]
        **kwargs  # type: Any
    ):
        # type: (...) -> "_models.ImageInsights"
        ...
        The Image Detail Search API lets you search on Bing and get back insights about an image, such
        as webpages that include the image. This section provides technical details about the query
        parameters and headers that you use to request insights of images and the JSON response objects
        that contain them. For examples that show how to make requests, see `Searching the Web for
        Images <https://docs.microsoft.com/en-us/bing/bing-image-search/overview>`_.
        ...
        :param accept_language: A comma-delimited list of one or more languages to use for user
         ...
         links to Bing.com properties in the response objects apply the specified language.
        :type accept_language: str
        :param content_type: Optional request header. If you set the `modules
         <https://docs.microsoft.com/en-us/bing/bing-image-search/overview>`_ query parameter to
         RecognizedEntities, you may specify the binary of an image in the body of a POST request. If
         you specify the image in the body of a POST request, you must specify this header and set its
        ...
        :param location: A semicolon-delimited list of key/value pairs that describe the client's
         ...
         header and the X-MSEdge-ClientIP header, but at a minimum, you should include this header.
        :type location: str
        :param crop_bottom: The bottom coordinate of the region to crop. The coordinate is a fractional
         value of the original image's height and is measured from the top, left corner of the image.
         Specify the coordinate as a value from 0.0 through 1.0. Use this parameter only with the
         Insights API. Do not specify this parameter when calling the Images, Trending Images, or Web
         Search APIs.
        :type crop_bottom: float
        :param crop_left: The left coordinate of the region to crop. The coordinate is a fractional
         value of the original image's height and is measured from the top, left corner of the image.
         Specify the coordinate as a value from 0.0 through 1.0. Use this parameter only with the
         Insights API. Do not specify this parameter when calling the Images, Trending Images, or Web
         Search APIs.
        :type crop_left: float
        :param crop_right: The right coordinate of the region to crop. The coordinate is a fractional
         value of the original image's height and is measured from the top, left corner of the image.
         Specify the coordinate as a value from 0.0 through 1.0. Use this parameter only with the
         Insights API. Do not specify this parameter when calling the Images, Trending Images, or Web
         Search APIs.
        :type crop_right: float
        :param crop_top: The top coordinate of the region to crop. The coordinate is a fractional value
         of the original image's height and is measured from the top, left corner of the image. Specify
         the coordinate as a value from 0.0 through 1.0. Use this parameter only with the Insights API.
         Do not specify this parameter when calling the Images, Trending Images, or Web Search APIs.
        :type crop_top: float
        :param crop_type: The crop type to use when cropping the image based on the coordinates
         specified in the cal, cat, car, and cab parameters. The following are the possible values. 0:
         Rectangular (default). Use this parameter only with the Insights API. Do not specify this
         parameter when calling the Images, Trending Images, or Web Search APIs.
        :type crop_type: str or ~image_search_client.models.ImageCropType
        :param country_code: A 2-character country code of the country where the results come from. For
         a list of possible values, see `Market Codes <https://docs.microsoft.com/en-us/bing/bing-image-
         search/overview>`_. If you set this parameter, you must also specify the `Accept-Language
         <https://docs.microsoft.com/en-us/bing/bing-image-search/overview>`_ header. Bing uses the
        ...
        :param id: An ID that uniquely identifies an image. Use this parameter to ensure that the
         ...
         contains the ID that you set this parameter to.
        :type id: str
        :param image_url: The URL of an image that you want to get insights of. Use this parameter as
         an alternative to using the insightsToken parameter to specify the image. You may also specify
         the image by placing the binary of the image in the body of a POST request. If you use the
         binary option, see the `Content-Type <https://docs.microsoft.com/en-us/bing/bing-image-
         search/overview>`_ header. The maximum supported image size is 1 MB. Use this parameter only
         with the Insights API. Do not specify this parameter when calling the Images, Trending Images,
         or Web Search APIs.
        :type image_url: str
        :param insights_token: An image token. The `Image <https://docs.microsoft.com/en-us/bing/bing-
         image-search/overview>`_ object's `imageInsightsToken <https://docs.microsoft.com/en-
         us/bing/bing-image-search/overview>`_ contains the token. Specify this parameter to get
         additional information about an image, such as a caption or shopping source. For a list of the
         additional information about an image that you can get, see the `modules
         <https://docs.microsoft.com/en-us/bing/bing-image-search/overview>`_ query parameter. Use this
         parameter only with the Insights API. Do not specify this parameter when calling the Images,
        ...
        :param modules: A comma-delimited list of insights to request. The following are the possible
         case-insensitive values. All: Return all insights, if available, except RecognizedEntities.
         BRQ: Best representative query. The query term that best describes the image. Caption: A
         caption that provides information about the image. If the caption contains entities, the
         response may include links to images of those entities. Collections: A list of related images.
         Recipes: A list of recipes for cooking the food shown in the images. PagesIncluding: A list of
         webpages that include the image. RecognizedEntities: A list of entities (people) that were
         recognized in the image. NOTE: You may not specify this module with any other module. If you
         specify it with other modules, the response doesn't include recognized entities.
         RelatedSearches: A list of related searches made by others. ShoppingSources: A list of
         merchants where you can buy related offerings. SimilarImages: A list of images that are
         visually similar to the original image. SimilarProducts: A list of images that contain a
         product that is similar to a product found in the original image. Tags: Provides
         characteristics of the type of content found in the image. For example, if the image is of a
         person, the tags might indicate the person's gender and type of clothes they're wearing. If you
         specify a module and there is no data for the module, the response object doesn't include the
         related field. For example, if you specify Caption and it does not exist, the response doesn't
         include the imageCaption field. To include related searches, the request must include the
         original query string. Although the original query string is not required for similar images or
         products, you should always include it because it can help improve relevance and the results.
        ...
        :type modules: list[str or ~image_search_client.models.ImageInsightModule]
        :param market: The market where the results come from. Typically, mkt is the country where the
         user is making the request from. However, it could be a different country if the user is not
         located in a country where Bing delivers results. The market must be in the form
         :code:`<language code>`-:code:`<country code>`. For example, en-US. The string is case
        ...
        :type set_lang: str
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: ImageInsights, or the result of cls(response)
    ...
    def trending(
        ...
        **kwargs  # type: Any
        ...
        The Image Trending Search API lets you search on Bing and get back a list of images that are
        trending based on search requests made by others. The images are broken out into different
        categories. For example, Popular People Searches. For a list of markets that support trending
        images, see `Trending Images <https://docs.microsoft.com/en-us/bing/bing-image-
        search/overview>`_.
        ...
        :param country_code: A 2-character country code of the country where the results come from.
         This API supports only the United States, Canada, Australia, and China markets. If you specify
         this query parameter, it must be set to us, ca, au, or cn. If you set this parameter, you must
         also specify the Accept-Language header. Bing uses the first supported language it finds from
         the languages list, and combine that language with the country code that you specify to
         determine the market to return results for. If the languages list does not include a supported
         language, Bing finds the closest language and market that supports the request, or it may use
         an aggregated or default market for the results instead of a specified one. You should use this
         query parameter and the Accept-Language query parameter only if you specify multiple languages;
         otherwise, you should use the mkt and setLang query parameters. This parameter and the mkt
        ...
        :type set_lang: str
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: TrendingImages, or the result of cls(response)
