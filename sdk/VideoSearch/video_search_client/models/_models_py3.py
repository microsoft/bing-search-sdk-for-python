...
class QueryContext(msrest.serialization.Model):
    ...
    def __init__(self, *, original_query: str, **kwargs):
...
class TrendingVideosCategory(msrest.serialization.Model):
    ...
    def __init__(
        self, *, title: str, subcategories: List["TrendingVideosSubcategory"], **kwargs
    ):
...
class TrendingVideosSubcategory(msrest.serialization.Model):
    ...
    def __init__(self, *, title: str, tiles: List["TrendingVideosTile"], **kwargs):
...
class Videos(SearchResultsAnswer):
    ...
    def __init__(
        self, *, value: List["VideoObject"], type: Optional[str] = None, **kwargs
    ):
